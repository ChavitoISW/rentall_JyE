...
export function generarPDFContrato(contratoData: ContratoData): Promise<Buffer> {
  return new Promise((resolve, reject) => {
    ...
    doc
      ...
      .font('Helvetica')
      .fillColor('#081233')
      .text('Propietario Jhonny Víquez Loría', margin + 20, margin + 35)
      .fontSize(9)
      .font('Helvetica')
      .fillColor('black')
...
export function generarPDFSolicitudEquipo(solicitudData: SolicitudEquipoData): Promise<Buffer> {
  return new Promise((resolve, reject) => {
    ...
    doc
      ...
      .font('Helvetica-Bold')
      .fillColor('#1E40AF')
      .text('MABI', margin + 20, margin + 15, { align: 'left' })
      .fontSize(12)
      .font('Helvetica')
      .fillColor('#081233')
      .text('Propietario Rafael Víquez Loría', margin + 20, margin + 35)
      .fontSize(9)
      .font('Helvetica')
      .fillColor('black')
      .text('Teléfonos: 61055381', margin + 20, margin + 50)
      .text('Alajuela, Costa Rica', margin + 20, margin + 65)
      .text('Reparación, Venta y alquiler de mezcladoras de concreto y equipos', margin + 20, margin + 80);
